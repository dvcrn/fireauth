defmodule Fireauth.SessionCookieValidator.Firebase do
  @moduledoc """
  Firebase session cookie validator.

  Verifies the JWT header/payload constraints documented by Firebase and checks
  the RS256 signature using the public keys published by Google (Identity Toolkit).
  """

  @behaviour Fireauth.SessionCookieValidator
